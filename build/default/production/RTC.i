...
void main(void)
{
    ...
    while(1)
    {
        ...
        if((giobt==BCDtoDec(RTCbits.hour ) || giobt==BCDtoDec(RTCbits.hour & ~(3<<5))+12 ||giobt==BCDtoDec(RTCbits.hour & ~(3<<5)) )&& phutbt==BCDtoDec(RTCbits.min) && giaybt==BCDtoDec(RTCbits.sec) && demmenu==0)
        {
...
void SetThu()
{
    if (RB3 == 0) {while(RB3==0); thu = (thu==7?1:(thu+1));}
    if (RB4 == 0) {while(RB4==0); thu = (thu==1?7:(thu-1));}
    LCD_gotoxy(1,1);
...
void SetNgay()
{
    if (RB3 == 0) {while(RB3==0); ngay = (ngay==31?1:(ngay+1));}
    if (RB4 == 0) {while(RB4==0); ngay = (ngay==1?31:(ngay-1));}
    LCD_gotoxy(1,1);
...
void SetThang()
{
    if (RB3 == 0) {while(RB3==0); thang = (thang==12?1:(thang+1));}
    if (RB4 == 0) {while(RB4==0); thang = (thang==1?12:(thang-1));}
    LCD_gotoxy(1,1);
...
void SetNamchuc()
{
    if (RB3 == 0) {while(RB3==0); namch = (namch==9?0:(namch+1));}
    if (RB4 == 0) {while(RB4==0); namch = (namch==0?9:(namch-1));}
    LCD_gotoxy(1,1);
...
void SetNamdv()
{
    if (RB3 == 0) {while(RB3==0); namdv = (namdv==9?0:(namdv+1));}
    if (RB4 == 0) {while(RB4==0); namdv = (namdv==0?9:(namdv-1));}
    LCD_gotoxy(1,1);
    LCD_puts("  CAI DAT NAM  ");
    LCD_gotoxy(2,1);
    LCD_puts("   NAMDV: ");
...
void SetGio()
{
    if (RB3 == 0) {while(RB3==0); gio = (gio==23?0:(gio+1));}
    if (RB4 == 0) {while(RB4==0); gio = (gio==0?23:(gio-1));}
    LCD_gotoxy(1,1);
...
void SetPhut()
{
    if (RB3 == 0) {while(RB3==0); phut = (phut==59?0:(phut+1));}
    if (RB4 == 0) {while(RB4==0); phut = (phut==0?59:(phut-1));}
    LCD_gotoxy(1,1);
...
void SetGiay()
{
    if (RB3 == 0) {while(RB3==0); giay = (giay==59?0:(giay+1));}
    if (RB4 == 0) {while(RB4==0); giay = (giay==0?59:(giay-1));}
    LCD_gotoxy(1,1);
...
void Setup_Alarm()
{
    ...
    while(1)
    {
        if(dis<5) Display_Alarm(0);
        else Display_Alarm(BthucMode);
        dis++;
        if(dis>9) dis=0;
