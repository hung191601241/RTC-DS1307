...
SOURCEFILES_QUOTED_IF_SPACED=RTC.c LCD_I2C.c I2C_Master.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/RTC.p1 ${OBJECTDIR}/LCD_I2C.p1 ${OBJECTDIR}/I2C_Master.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/RTC.p1.d ${OBJECTDIR}/LCD_I2C.p1.d ${OBJECTDIR}/I2C_Master.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/RTC.p1 ${OBJECTDIR}/LCD_I2C.p1 ${OBJECTDIR}/I2C_Master.p1

# Source Files
SOURCEFILES=RTC.c LCD_I2C.c I2C_Master.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/RTC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/RTC.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/RTC.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
